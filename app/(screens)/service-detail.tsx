    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ padding: 15 }}>
        ...
        <View style={styles.infoSection}>
          ...
          <Text style={styles.serviceType}>{service.serviceType.replace("_", " ")}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.priceRow}>
            <Text style={styles.priceLabel}>Giá / slot ({service.slotDurationHours}h)</Text>
            <Text style={styles.priceValue}>{formatPrice(service.pricePerSlot)}</Text>
          </View>
          ...
          <View style={styles.priceRow}>
            ...
            <Text style={styles.priceValue}>{formatPrice(service.depositAmount)}</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  infoSection: { paddingVertical: 15, borderBottomWidth: 1, borderBottomColor: "#F0F0F0" },
  ...
  paymentRow: { flexDirection: "row", alignItems: "center", paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "#F5F5F5", paddingHorizontal: 4, borderRadius: 8, marginBottom: 4 },
  ...
  summaryBox: { marginTop: 25, padding: 20, backgroundColor: "#FAF9FF", borderRadius: 12, borderWidth: 1, borderColor: "#F0EFFF" },
